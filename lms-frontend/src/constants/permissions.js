...
const PERMISSION_VALUES = Object.freeze({
  ...
  ENROLLMENT_READ: 'ENROLLMENT_VIEW',
  ENROLLMENT_WRITE: 'ENROLLMENT_UPDATE',
  ASSESSMENT_READ: 'ASSESSMENT_VIEW',
  ASSESSMENT_WRITE: 'ASSESSMENT_UPDATE',
  ASSESSMENT_GRADE: 'GRADING_EVALUATE',
  CERTIFICATE_READ: 'CERTIFICATE_VIEW',
  ANALYTICS_READ: 'ANALYTICS_VIEW',
  SUBSCRIPTION_READ: 'SUBSCRIPTION_READ',
  SUBSCRIPTION_MANAGE: 'SUBSCRIPTION_MANAGE',
  TENANT_READ: 'ORGANIZATION_VIEW',
  TENANT_MANAGE: 'ORGANIZATION_MANAGE',

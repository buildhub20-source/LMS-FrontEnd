...
export const MyCoursesPage = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return courses.filter((c) => c.level?.toLowerCase() === categoryFilter.toLowerCase());
                ...
                {categories.map((cat) => (
                  <button
                    ...
                    style={{
                      ...
                      color:
                        cat === categoryFilter ? 'var(--text-primary)' : 'var(--text-secondary)',
                      fontFamily: 'Inter, sans-serif',
                      fontWeight: cat === categoryFilter ? 600 : 400,
                    }}
                    onMouseEnter={(e) => (e.currentTarget.style.background = 'var(--hover-bg)')}
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.background =
                        cat === categoryFilter ? 'var(--hover-bg)' : 'transparent')
                    }
                  >
                    {cat}
                  </button>

                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <div>
                      ...
                      <strong style={{ fontSize: 12, color: 'var(--text-primary)' }}>
                        {info.canRetake && used >= configuredMax
                          ? `${used} Used (Retake Granted)`
                          : used >= configuredMax
                          ? `${used}/${configuredMax} (Max)`
                          : `${used}/${configuredMax} Used`}
                      </strong>
                    </div>
                  </div>
                ...
                {used > 0 && (
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4, fontSize: 11 }}>
                      ...
                      <span style={{ color: isInProgress ? '#818cf8' : info.canRetake ? '#10b981' : used >= configuredMax ? '#ef4444' : '#10b981', fontWeight: 700 }}>
                        {isInProgress
                          ? 'In Progress'
                          : info.canRetake && used >= configuredMax
                          ? `Attempt ${used} Completed (Retake Available)`
                          : used >= configuredMax
                          ? `${configuredMax} of ${configuredMax} (Completed)`
                          : `${used} of ${configuredMax} Attempted`}
                      </span>
                    </div>
                    <div style={{ height: 4, background: 'rgba(255,255,255,0.08)', borderRadius: 4, overflow: 'hidden' }}>
                      <div
                        style={{
                          height: '100%',
                          width: `${info.canRetake ? 100 : attemptsPct}%`,
                          background: isInProgress ? '#6366f1' : info.canRetake ? '#10b981' : used >= configuredMax ? '#ef4444' : '#10b981',
                          borderRadius: 4,

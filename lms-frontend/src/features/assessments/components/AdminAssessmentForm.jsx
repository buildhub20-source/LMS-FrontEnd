            ...
            <div className={s.sectionHead}>
              ...
              <div className={s.sectionMeta}>
                ...
                <p className={s.sectionDesc}>
                  Control how long students have and how often they can try
                </p>
              </div>
            </div>
            <div className={s.sectionBody}>
          ...
          <div className={s.section}>
            <div className={s.sectionHead}>
              ...
              <div className={s.sectionMeta}>
                ...
                <p className={s.sectionDesc}>
                  Restrict when students can access this assessment (optional)
                </p>
              </div>
            </div>
            <div className={s.sectionBody}>
          ...
          <div className={s.helpCard}>
            ...
            <div className={s.helpItem}>
              ...
              <p className={s.helpText}>
                <strong>Marks are automatic.</strong> Total marks are summed from all question marks
            ...
            <div className={s.helpItem}>
              <div className={s.helpDot} />
              <p className={s.helpText}>
                <strong>Scheduling is optional.</strong> Leave blank to let students attempt anytime
                after publishing.
              </p>
            </div>
            <div className={s.helpItem}>
              <div className={s.helpDot} />
              <p className={s.helpText}>
                <strong>Add questions after saving.</strong> You'll be taken to the assessment page
                to add coding problems.
              </p>
            </div>
          </div>
        </div>

 ...
 */
export const AdminInput = forwardRef(({ label, error, icon, hint, style = {}, className = '', ...props }, ref) => (
  <div style={{ width: '100%' }}>
    {label && (
      <label style={{
    ...
    <div style={{ position: 'relative' }}>
      ...
      <input
        ...
        onBlur={(e) => { e.target.style.borderColor = error ? 'rgba(239,68,68,0.6)' : 'var(--border-color)'; }}
        {...props}
      />
    </div>
    {error ? (
